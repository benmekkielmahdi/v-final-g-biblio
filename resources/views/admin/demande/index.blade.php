                ...
                <div id="layoutSidenav_content">
                    <main>
                        <div class="container-fluid px-4">
                            <h1 class="mt-4">demandes</h1>
                            <ol class="breadcrumb mb-4">
                                <li class="breadcrumb-item active">Dashboard</li>
                            </ol>
                            <a href="{{ url('Category/create') }}"><button  class="btn btn-success" ><i class="fa fa-plus-circle" aria-hidden="true"></i> Ajouter Demande</button></a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <select name="etat">
                                                <option value="encours" {{ $cat->etat == 'encours' ? 'selected' : '' }}>En cours</option>
                                                <option value="valider" {{ $cat->etat == 'valider' ? 'selected' : '' }}>Valider</option>
                                                <option value="refuser" {{ $cat->etat == 'refuser' ? 'selected' : '' }}>Refuser</option>
                                                <!-- Ajoutez d'autres options selon vos besoins -->
                                            </select>
                                        </td>

                                        
                                        <td>{{ $cat->oeuvre->titre}}</td>
                                        <td>{{ $cat->dateRes}}</td>
